  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline:     'border border-slate-200 dark:border-zinc-700 bg-transparent hover:bg-slate-50 dark:hover:bg-zinc-800 text-slate-700 dark:text-zinc-200',
        secondary:   'bg-slate-100 dark:bg-zinc-800 text-slate-900 dark:text-zinc-100 hover:bg-slate-200 dark:hover:bg-zinc-700',
        ghost:       'hover:bg-slate-100 dark:hover:bg-zinc-800 text-slate-700 dark:text-zinc-200',
